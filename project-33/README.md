...
1. **Writers have significantly weaker Mars dignity** (Tropical, p=0.011): consistent with the writer archetype as observer, introvert, interior explorer — the antithesis of Martian assertion
2. **Filmmakers have significantly stronger Sun dignity** (Tropical, p=0.027): consistent with the director archetype as singular solar authority radiating creative vision outward
