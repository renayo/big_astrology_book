...
def load_and_process_data():
    ...
    for _, row in df.iterrows():
        try:
            get_target(row) # ensure valid dates
            ...
            # Using only Tropical for now to see if it's enough (simplifying for speed/clarity) 
            # Wait, the previous run had Vedic too. I should include them to be consistent.
